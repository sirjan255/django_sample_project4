...
# Step 15: Push the Project to GitHub

After completing the Django project, Git was used to upload the project to GitHub.

The virtual environment was intentionally excluded from Git using `.gitignore`.
...
This means files such as the local virtual environment and Python cache files are not included in the Git repository.

Git was initialized from the project root:

```text
C:\Users\ASUS\django_sample_project4
```
...
The project files were staged using:

```powershell
git add .
```

The staged files were checked using:
...
```powershell
git remote add origin https://github.com/sirjan255/django_sample_project4.git
```
...
Finally, the project was pushed to GitHub using:

```powershell
git push -u origin main
```

The GitHub repository contains the Django project files, while `pr4env/` remains excluded.
